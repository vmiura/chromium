...
template <>
struct StructTraits<gfx::mojom::ScrollOffset, gfx::ScrollOffset> {
  static double x(const gfx::ScrollOffset& offset) { return offset.x(); }

  static double y(const gfx::ScrollOffset& offset) { return offset.y(); }
